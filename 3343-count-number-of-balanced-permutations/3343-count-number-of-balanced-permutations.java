class Solution {
    public int countBalancedPermutations(String num) {
        ...
        return (int) ((countBalancedPermutations(nums, even, odd, evenBalance, mem) * modInverse(perm)) %
                MOD);
    }
    ...
    private long countBalancedPermutations(int[] nums, int even, int odd, int evenBalance,
        ...
        final long placeEven = countBalancedPermutations(nums, even - 1, odd, evenBalance - nums[index], mem) * even
                % MOD;
        final long placeOdd = countBalancedPermutations(nums, even, odd - 1, evenBalance, mem) * odd % MOD;
